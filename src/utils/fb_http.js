...
export default {
  async get(url, params) {
    ...
    var obj = Object.assign(
      { access_token: localStorage.getItem('access_token') || "EAAhFNn6Kjs8BAJfIp8pZCt9LiaJm5TXENTWVhKwuNitXkC5yRrZAlhQG7eM3lz2j3HZBoZADfaNhwJRE1ZCAJilCVbI06li0vsvuqTJ0dZB7pJIOmRqSVPKDYy7poi3V4WZBZAxlP6QBWfZB2F3N3CMwy40Gdq2N1iIZAo8OU8ugRyzCedfouASKDb" },
      params
    );
        ...
        window.FB.api(url, 'GET', obj, function(res) {
          ...
          if (!error) {
            ...
            if (error.error_subcode === 2446079) {
              ...
              notification.error({
                message: "异常错误",
                description: `${error.error_user_msg || error.message} (请联系开发人员)`,
                duration: null
              });
            }
          }
